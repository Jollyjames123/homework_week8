...
public class Pr16Point {
    ...
    public double distance(Pr16Point second) {
        return Math.sqrt((second.getX() - this.getX()) * (second.getX() - this.getX()) + (second.getY() - this.getY()) * (second.getY() - this.getY()));
    }

    public static void main(String[] args) {
        Pr16Point first = new Pr16Point(6, 5);
        Pr16Point second = new Pr16Point(3, 1);
        System.out.println("distance(0,0)= " + first.distance());

        System.out.println("distance(second)= " + first.distance(second));
        System.out.println("distance(2,2)= " + first.distance(2, 2));
        Pr16Point point = new Pr16Point();
        System.out.println("distance()= " + point.distance());
    }
